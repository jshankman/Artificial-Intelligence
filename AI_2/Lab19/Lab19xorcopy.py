...
def XOR():
  ...
  while epoch < 1500:
    ...
    error1 = 0.5*(pow(ff3(w0,w1 + 0.01,0, w2, 0, w3, 0) - 1, 2) + pow(ff3(w0,w1 + 0.01,1, w2, 1, w3, 1) - 0, 2))
    error2 = 0.5*(pow(ff3(w0, w1, 0, w2 + 0.01, 0, w3, 0) - 1, 2) + pow(ff3(w0, w1, 1, w2 + 0.01, 1, w3, 1) - 0, 2))
    error3 = 0.5*(pow(ff3(w0, w1, 0, w2, 0, w3 + 0.01, 0) - 1, 2) + pow(ff3(w0, w1, 1, w2, 1, w3 + 0.01, 1) - 0, 2))
...
def listLearn():
  ...
  while epoch < 1500:
    ...
    error = 0.5*(pow(ff2(w0,w1,0, w2, 0) - 1, 2) + pow(ff2(w0,w1,1, w2, 1) - 0, 2))
    error0 = 0.5*(pow(ff2(w0 + 0.01,w1,0, w2, 0) - 1, 2) + pow(ff2(w0 + 0.01,w1,1, w2, 1) - 0,2))
    error1 = 0.5*(pow(ff2(w0,w1 + 0.01,0, w2, 0) - 1, 2) + pow(ff2(w0,w1 + 0.01,1, w2, 1) - 0, 2))
    error2 = 0.5*(pow(ff2(w0, w1, 0, w2 + 0.01, 0) - 1, 2) + pow(ff2(w0, w1, 1, w2 + 0.01, 1) - 0, 2))
